//
//  DICHOSearchUsernameViewController.h
//  Dicho
//
...
@interface DICHOSearchUsernameViewController : UIViewController <UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate>
{
