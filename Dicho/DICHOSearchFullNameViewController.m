//
//  DICHOSearchFullNameViewController.m
//  Dicho
//
...
#import "DICHOSearchFullNameViewController.h"
#import <QuartzCore/QuartzCore.h>
#import "DICHOAsyncImageViewRound.h"
#import "DICHOSingleUserViewController.h"

@interface DICHOSearchFullNameViewController ()

@end

@implementation DICHOSearchFullNameViewController
@synthesize fullNameSearchBar;
...
- (void)viewDidLoad
{
    ...
    [fullNameSearchBar becomeFirstResponder];
    fullNameSearchBar.tintColor = [UIColor colorWithRed:0.0 green:0.3 blue:0.6 alpha:1.0];
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar {
    ...
    [searchAlert show];
    [fullNameSearchBar resignFirstResponder];
    
    NSString *givenFullNameSearch = fullNameSearchBar.text;
    NSString *encodedNameSearch = (NSString *)CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(
                                                                                                      NULL,
                                                                                                      (__bridge CFStringRef) givenFullNameSearch,
                                                                                                      NULL,
                                                                                                      (CFStringRef)@"!*'();:@&=+$,/?%#[]",
                                                                                                      kCFStringEncodingUTF8));
    NSString *strURL = [NSString stringWithFormat:@"http://dichoapp.com/files/searchFullName2.php?givenSearch=%@", encodedNameSearch];
