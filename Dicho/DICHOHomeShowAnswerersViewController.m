//
//  DICHOHomeShowAnswerersViewController.m
//  Dicho
//
...
#import "DICHOHomeShowAnswerersViewController.h"

@interface DICHOHomeShowAnswerersViewController ()

@end

@implementation DICHOHomeShowAnswerersViewController
...
- (void)viewDidLoad
{
    ...
    selectedDichoID = [prefs objectForKey:@"homeSelectedDichoID"];
